...
def handle_tag_run_lint(gh_repo, pr, comment, user_perms, react_on_success=True):
    """
    Handles the /tag-run-lint command.
    Returns True if action was taken, False otherwise.
    """
    print("lint permission is granted to everyone. Adding 'run-lint' label.")
    pr.add_to_labels("lint wanted")
